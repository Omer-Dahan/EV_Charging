...
INFO_HOW_MESSAGE = (
    ...
    "• <b>מפה אינטראקטיבית:</b> כפתור <b>מפת עמדות</b> (בצד שמאל ליד שדה הכתיבה) פותח מפה חיה עם כל העמדות — אפשר לחפש, לסנן לפי מפעיל ומהירות, ולראות את כל האזור\n\n"
    "🔒 <b>פרטיות:</b>\n"
    "המיקום שלך משמש אך ורק לחיפוש העמדות הקרובות ברגע הבקשה, ולא נשמר בשום מאגר נתונים.\n\n"
    "📊 <b>מאגר הנתונים ורמת העדכון:</b>\n"
    "הבוט מאחד כ-3,500 אתרי טעינה ממספר מקורות: המאגר הלאומי של משרד האנרגיה (CelloCharge), data.gov.il ומקורות נוספים. "
